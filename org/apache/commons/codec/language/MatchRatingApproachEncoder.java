...
implements StringEncoder {
    ...
    String cleanName(String name) {
        ...
        String[] arr$ = charsToTrim = new String[]{"\\-", "[&]", "\\'", "\\.", "[\\,]"};
        int len$ = arr$.length;
        int i$ = 0;
        do {
            if (i$ >= len$) {
    ...
    public boolean isEncodeEquals(String name1, String name2) {
        ...
        if (count < minRating) return false;
        return true;
    }

    boolean isVowel(String letter) {
        if (letter.equalsIgnoreCase("E")) return true;
        if (letter.equalsIgnoreCase("A")) return true;
        if (letter.equalsIgnoreCase("O")) return true;
        if (letter.equalsIgnoreCase("I")) return true;
        if (letter.equalsIgnoreCase("U")) return true;
        return false;
    }
