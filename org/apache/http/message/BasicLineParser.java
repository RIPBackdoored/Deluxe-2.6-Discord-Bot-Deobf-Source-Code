...
implements LineParser {
    ...
    public static ProtocolVersion parseProtocolVersion(String value, LineParser parser) throws ParseException {
        ...
        if (parser != null) {
            lineParser = parser;
            return lineParser.parseProtocolVersion(buffer, cursor);
        }
        lineParser = INSTANCE;
        return lineParser.parseProtocolVersion(buffer, cursor);
    }
    ...
    public boolean hasProtocolVersion(CharArrayBuffer buffer, ParserCursor cursor) {
        ...
        if (!ok) return ok;
        if (buffer.charAt(index + protolength) != '/') return false;
        return true;
    }
    ...
    public static RequestLine parseRequestLine(String value, LineParser parser) throws ParseException {
        ...
        if (parser != null) {
            lineParser = parser;
            return lineParser.parseRequestLine(buffer, cursor);
        }
        lineParser = INSTANCE;
        return lineParser.parseRequestLine(buffer, cursor);
    }
    ...
    public static StatusLine parseStatusLine(String value, LineParser parser) throws ParseException {
        ...
        if (parser != null) {
            lineParser = parser;
            return lineParser.parseStatusLine(buffer, cursor);
        }
        lineParser = INSTANCE;
        return lineParser.parseStatusLine(buffer, cursor);
    }
    ...
    public static Header parseHeader(String value, LineParser parser) throws ParseException {
        ...
        if (parser != null) {
            lineParser = parser;
            return lineParser.parseHeader(buffer);
        }
        lineParser = INSTANCE;
        return lineParser.parseHeader(buffer);
    }
