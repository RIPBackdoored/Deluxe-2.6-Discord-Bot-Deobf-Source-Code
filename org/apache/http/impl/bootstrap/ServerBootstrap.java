...
public class ServerBootstrap {
    ...
    public HttpServer create() {
        ...
        if ((responseFactoryCopy22 = this.responseFactory) == null) {
            DefaultHttpResponseFactory responseFactoryCopy22 = DefaultHttpResponseFactory.INSTANCE;
        }
        HttpService httpService = new HttpService(httpProcessorCopy, connStrategyCopy, (HttpResponseFactory)responseFactoryCopy22, handlerMapperCopy, this.expectationVerifier);
        ...
        int n = this.listenerPort > 0 ? this.listenerPort : 0;
        if (this.socketConfig != null) {
            socketConfig = this.socketConfig;
            return new HttpServer(n, this.localAddress, socketConfig, serverSocketFactoryCopy, httpService, connectionFactoryCopy, this.sslSetupHandler, exceptionLoggerCopy);
        }
